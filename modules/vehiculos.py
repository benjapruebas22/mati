...
def register_vehiculos(app, get_db, get_db_connection, ensure_cols, ensure_combustible_columns, rebuild_eventos_vehiculos):
    ...
    @app.route("/vehiculos", methods=["GET", "POST"], endpoint="vehiculos_home")
    def vehiculos_home():
    ...
    @app.route("/viajes/<int:viaje_id>/editar2", methods=["GET", "POST"], endpoint="viaje_editar2")
    def viaje_editar2(viaje_id):
        # Ruta antigua: mantener compatibilidad y redirigir a la ruta unica.
    ...
    @app.route("/vehiculos/control_diario", methods=["GET", "POST"], endpoint="vehiculos_control_diario")
    def vehiculos_control_diario():
        ...
        if request.method == "POST":
            ...
            # Sector y dependencia salen del personal_sede
            sector = ""
            dependencia = ""
            if personal_id:
                pr = conn.execute("""
